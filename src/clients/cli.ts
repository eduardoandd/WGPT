...
/**
 * Adapter de linha de comando — útil para desenvolvimento local e testes
 * sem precisar do WhatsApp.
 *
 * Uso: basta trocar WhatsAppAdapter por CLIAdapter em src/index.ts
 */
export class CLIAdapter implements ClientAdapter {
    ...
    async sendText(_chatId: string, text: string): Promise<void> {
        // Remove o prefixo 🤖 que o core adiciona para exibição mais limpa no terminal
